...
$options = array(
	...
	'layout'        => array(
		'label'   => esc_html__( 'Layout', 'pet-space' ),
		'desc'    => esc_html__( 'Choose layout', 'pet-space' ),
		'value'   => 'carousel',
		'type'    => 'select',
		'choices' => array(
	...
	'show_excerpt'  => array(
		'type'         => 'switch',
		'value'        => '',
		'label'        => esc_html__( 'Show excerpt', 'pet-space' ),
		'desc'         => esc_html__( 'Hide or show excerpt', 'pet-space' ),
		'left-choice'  => array(
			'value' => 'hide-excerpt',
			'label' => esc_html__( 'No', 'pet-space' ),
		),
	...
	'show_socials'  => array(
		'type'         => 'switch',
		'value'        => '',
		'label'        => esc_html__( 'Show socials', 'pet-space' ),
		'desc'         => esc_html__( 'Hide or show socials icons', 'pet-space' ),
		'left-choice'  => array(
			'value' => 'hide-socials',
			'label' => esc_html__( 'No', 'pet-space' ),
		),
    ...
    'link' => pet_space_read_more_options( esc_html__( 'Show Read More', 'pet-space' ), 'color3' ),
	'cat' => array(
		'type'  => 'multi-select',
		'label' => esc_html__('Select categories', 'pet-space'),
		'desc'  => esc_html__('You can select one or more categories', 'pet-space'),
		'population' => 'taxonomy',
		'source' => $taxonomy,
		'prepopulate' => 10,
		'limit' => 100,
