				...
				<div class="entry-content">
					<div class="entry-attachment bottommargin_40">
						<div class="attachment">
							<?php pet_space_the_attached_image(); ?>
						</div><!-- .attachment -->
					...
					<header class="entry-header">
						<div class="entry-meta item-meta">
							...
							<?php pet_space_posted_on( true, true ); ?>
							<?php esc_html_e( 'in', 'pet-space' ); ?> <span class="parent-post-link darklinks"><a href="<?php echo get_permalink( $post->post_parent ); ?>"><?php echo get_the_title( $post->post_parent ); ?></a></span>
						</div><!-- .entry-meta -->
					</header><!-- .entry-header -->
					<?php
					the_content();
					wp_link_pages( array(
						'before'      => '<div class="page-links"><span class="page-links-title">' . esc_html__( 'Pages:', 'pet-space' ) . '</span>',
						'after'       => '</div>',
						'link_before' => '<span>',
						'link_after'  => '</span>',
					) );
			...
			<nav id="image-navigation"
				...
				<div class="display_table">
					<div class="display_table_cell">
						<?php previous_image_link( false, '<div class="previous-image">' . esc_html__( 'Previous Image', 'pet-space' ) . '</div>' ); ?>
					</div>
					<div class="display_table_cell text-right">
						<?php next_image_link( false, '<div class="next-image">' . esc_html__( 'Next Image', 'pet-space' ) . '</div>' ); ?>
					</div>
				</div><!-- .nav-links -->
